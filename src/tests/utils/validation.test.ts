...
describe('בדיקות חברותיות למידע 🤔', () => {
  ...
  describe('validateSchedule - בדיקת מערכת שעות', () => {
    test('מערכת שעות תקינה ✅', () => {
      const schedule = {
        title: 'מתמטיקה',
        day_of_week: 1,
        start_time: '08:00',
    ...
    test('מערכת שעות עם שעת סיום לפני שעת התחלה לא תקינה 🚫', () => {
      const schedule = {
        title: 'מתמטיקה',
        day_of_week: 1,
        start_time: '09:00',
    ...
    test('מערכת שעות ללא יום בשבוע לא תקינה 🚫', () => {
      const schedule = {
        title: 'מתמטיקה',
        start_time: '08:00',
        end_time: '09:30',
